...
public class AuthenticationService : IAuthenticationService
{
    ...
    public AuthenticationService(UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager, JwtSettings jwtSettings)
    {
    ...
    public async Task<JwtAuthResult> GenerateTokenAsync(AppUser user)
    {
